...
* 你的核心目标：
  ...
  * 该项目服务器信息在E:code\parlasoul-backend\.env
  * commit之前，需要运行测试，commit的时候，保持一个独立的主题，不要影响工作区的其他改动，也不要带入其他改动，push代码的时候，先push后端，然后去github上面监控cicd，等到后端部署成功之后，再push前端
  * 通过雪碧图新增svg
  * 把用户当作智力低下，没有耐心，暴躁的人，用这个思路去做方案
---
