...
export default function TopConsole({
  ...
  return (
    <header className="w-full border-b border-divider md:border-none bg-white md:bg-transparent">
      <div className="max-w-[1400px] mx-auto w-full flex items-center justify-between px-4 md:px-10 h-[64px] md:h-auto md:pt-6 md:mt-2 md:mb-4 relative">
        {/* 移动端汉堡按钮 */}
        {onToggleSidebar && (
          <button
            type="button"
